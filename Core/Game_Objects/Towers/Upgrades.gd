...
var ammo_upgrade = Classes.upgrade.new("Max ammo", 10, 1.05, [2, 1.05], 0)
var reload_time_upgrade = Classes.upgrade.new("Reload Time", 12, 1.15, [1, .95], 1)
var damage_upgrade = Classes.upgrade.new("Damage", 20, 1.07, [1, 1.05], 2)
var ammo_per_click_upgrade = Classes.upgrade.new("Ammo Per Click", 50, 1.12, [1, 1.05], 3)
var money_upgrade = Classes.upgrade.new("Money Per Kill", 10, 1.03, [1, 1.05], 4)
var attack_range_upgrade = Classes.upgrade.new("Attack Range", 40, 1.25, [250, 1.05], 5)
